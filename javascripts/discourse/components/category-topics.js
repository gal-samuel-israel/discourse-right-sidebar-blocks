...
export default class CategoryTopics extends Component {
  ...
  constructor() {
    ...
    this.bottom_link_text = this.args?.params?.bottom_link_text !== undefined ? this.args?.params?.bottom_link_text : null; /* bottom_link_text : text for the all items label */
