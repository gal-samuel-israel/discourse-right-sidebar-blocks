...
export default class CategoryTopics extends Component {
  ...
  constructor() {
    ...
    this.all_text_label = this.args?.params?.all_topics_label !== undefined ? this.args?.params?.all_topics_label : "All Topics"; /* bottom_link_text : text for the all items label */
